	...
	<section class="sidebar">
		...
		<div class="user-panel">
			...
			<div class="pull-left info">
				...
				<a href="#"><i class="fa fa-circle text-gray"></i> 离线</a>
			</div>
		</div>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="error-page">
					...
					<div class="error-content" style="margin-left: 50px;margin-top: 25%">
						<h3>登录失败 , 请<a href="${pageContext.request.contextPath}/pages/login.jsp">返回到登录页面</a>
							重新登录
                        </h3>
