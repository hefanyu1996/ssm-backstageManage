                    ...
                    <div class="table-box">
                        ...
                        <div class="tab-pane active" id="tab-label">
                            <div class="row data-type">
                                ...
                                <div class="col-md-4 data text">${orders.orderNum}</div>

                                <div class="col-md-2 title">下单时间</div>
                                <div class="col-md-4 data text">${orders.orderTimeStr}</div>

                                <div class="col-md-2 title">路线名称</div>
                                <div class="col-md-4 data text">${orders.product.productName}</div>

                                <div class="col-md-2 title">出发城市</div>
                                <div class="col-md-4 data text">${orders.product.cityName}</div>

                                <div class="col-md-2 title">出发时间</div>
                                <div class="col-md-4 data text">${orders.product.departureTimeStr}</div>

                                <div class="col-md-2 title">出游人数</div>
                                <div class="col-md-4 data text">${orders.peopleCount}</div>

                                <div class="col-md-2 title rowHeight2x">其他信息</div>
                                <div class="col-md-10 data rowHeight2x">
                                    <textarea class="form-control" rows="3" placeholder="请输入..."
                                              disabled="disabled">${orders.orderDesc}
                                    </textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="tab-pane" id="tab-treetable">
                            <table id="collapse-table" class="table table-bordered table-hover dataTable">
                                ...
                                <c:forEach items="${orders.travellerList}" var="traveller">
                                <tr>
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline" >
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default" title="返回" onclick="location.href='${pageContext.request.contextPath}/orders/findAll.do?page=1&pageSize='">
