...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/user/changeUserInfo.do"
              method="post" id="form">
            <!-- 正文区域 -->
                            ...
                            <div class="box-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered">
                                    ...
                                    <li class="list-group-item">
                                        <b style="line-height: 32px">email</b>
                                    ...
                                    <li class="list-group-item">
                                        <b style="line-height: 32px">手机号</b>
                                        <a class="pull-right" style="width: 120px">${msg}</a>
                                        <div class="col-md-6 data pull-right">
                                            <input type="text" class="form-control"
                                                   value="${userInfo.phoneNum}" name="phoneNum">
                                        </div>
                                    </li>
                                </ul>
